...
execute if score id astrbot.temp matches 1 run return run loot replace entity @s contents loot astrbot:automatic_repairment
execute if score id astrbot.temp matches 2 run return run loot replace entity @s contents loot astrbot:external_backpack
...
execute if score id astrbot.temp matches 5 run return run loot replace entity @s contents loot astrbot:mineral_detector
...
execute if score id astrbot.temp matches 8 run return run loot replace entity @s contents loot astrbot:payload_ejector
