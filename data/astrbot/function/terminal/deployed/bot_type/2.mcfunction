...
execute unless data entity @s item.components."minecraft:custom_data".astrbot.modules[{slot:2}] run data modify storage astrbot:terminal dialog.body.contents[17] set value {color:"red",translate:"dialog.astrbot.no_module"}
execute unless data entity @s item.components."minecraft:custom_data".astrbot.modules[{slot:3}] run data modify storage astrbot:terminal dialog.body.contents[21] set value {color:"red",translate:"dialog.astrbot.no_module"}
