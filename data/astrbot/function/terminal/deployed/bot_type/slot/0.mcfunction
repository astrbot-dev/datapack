...
data modify storage astrbot:terminal dialog.body.contents[9].color set value "green"
data modify storage astrbot:terminal dialog.body.contents[9].translate set from storage astrbot:terminal temp2