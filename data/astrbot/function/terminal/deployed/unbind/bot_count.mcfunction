...
execute if score #bot_type astrbot.var matches 2 on vehicle run function astrbot:terminal/deployed/unbind/bettery
execute on vehicle run function astrbot:data/bot/clear/main