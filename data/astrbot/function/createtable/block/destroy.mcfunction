...
execute as @e[distance=..7, tag=astrbot.createtable.interaction] at @s if function astrbot:createtable/block/destroy/check_use run function astrbot:createtable/block/destroy/use
