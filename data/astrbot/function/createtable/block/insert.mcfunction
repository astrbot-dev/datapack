...
execute as @e[distance=..7, tag=astrbot.createtable.slot] at @s unless function astrbot:createtable/block/slot/check_use run function astrbot:createtable/block/slot/use
