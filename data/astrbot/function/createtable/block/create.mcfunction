...
execute as @e[distance=..7, tag=astrbot.createtable.interaction.has_bot] at @s if function astrbot:createtable/block/create/check_use run function astrbot:createtable/block/create/use
