...
execute as @e[tag=astrbot.createtable.bot.model, distance=0..0.9, type=item_display] if score @s astrbot.createtable_id = curr_createtable astrbot.temp run function astrbot:createtable/block/slot/set_slot_to_empty/qwq
