...
execute as @e[distance=..7, tag=astrbot.createtable.interaction] at @s unless function astrbot:createtable/block/put_bot/check_use run function astrbot:createtable/block/put_bot/use
