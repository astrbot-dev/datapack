...
execute if data storage astrbot:temp createtable.item.components."minecraft:custom_data".astrbot.modules[{slot:2}] run function astrbot:createtable/block/create/create_bot/2

execute if data storage astrbot:temp createtable.item.components."minecraft:custom_data".astrbot.modules[{slot:3}] run function astrbot:createtable/block/create/create_bot/3