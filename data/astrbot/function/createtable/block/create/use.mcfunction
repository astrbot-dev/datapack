...
execute as @n[tag=astrbot.createtable.interaction, distance=0..0.9, type=interaction] if score @s astrbot.createtable_id = curr_createtable astrbot.temp run function astrbot:createtable/block/create/enable_interaction
