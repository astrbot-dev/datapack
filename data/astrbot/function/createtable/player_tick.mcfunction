...
execute unless score displaying_error astrbot.temp matches 0.. unless items entity @s weapon.mainhand * at @s run function astrbot:createtable/player/guide/create_bot