...
# init
scoreboard players operation @s astrbot.player_attribute_base = @s astrbot.max_player_power_base
...
data modify storage astrbot:temp attribute set value {type:0b,amount:0}
data modify storage astrbot:temp attribute set from entity @s equipment.chest.components."minecraft:custom_data".max_player_power.chest
function astrbot:player/tick/bettery_attribute/attribute_process

data modify storage astrbot:temp attribute set value {type:0b,amount:0}
data modify storage astrbot:temp attribute set from entity @s equipment.legs.components."minecraft:custom_data".max_player_power.legs
function astrbot:player/tick/bettery_attribute/attribute_process

data modify storage astrbot:temp attribute set value {type:0b,amount:0}
data modify storage astrbot:temp attribute set from entity @s equipment.feet.components."minecraft:custom_data".max_player_power.feet
function astrbot:player/tick/bettery_attribute/attribute_process

data modify storage astrbot:temp attribute set value {type:0b,amount:0}
data modify storage astrbot:temp attribute set from entity @s equipment.mainhand.components."minecraft:custom_data".max_player_power.mainhand
function astrbot:player/tick/bettery_attribute/attribute_process
...
scoreboard players operation @s astrbot.max_player_power = @s astrbot.player_attribute_base