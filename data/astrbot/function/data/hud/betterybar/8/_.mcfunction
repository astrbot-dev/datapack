execute if score @s astrbot.player_power matches 001..020 run function astrbot:data/hud/betterybar/8/20
execute if score @s astrbot.player_power matches 021..040 run function astrbot:data/hud/betterybar/8/40
...
# execute if score @s astrbot.player_power matches 181..200 run function astrbot:data/hud/betterybar/8/200
