execute as @s[tag=!pdg] run scoreboard players set @s astrbot.flying_time 2

execute at @s[tag=hitb] run particle minecraft:trial_spawner_detection ^ ^-0.1 ^-0.2 0.01 0.01 0.01 0.04 20 force
execute at @s[scores={astrbot.flying_time=1..2}] run tag @e[tag=!bullet,tag=!M134,dx=0,dy=0,dz=0] add hit1
execute at @s[scores={astrbot.flying_time=1..2}] positioned ~-0.98 ~-0.98 ~-0.98 run damage @e[tag=hit1,dx=0,dy=0,dz=0,limit=1] 5 magic
