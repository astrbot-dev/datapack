execute as @s at @s run tp @s ~ ~ ~ facing entity @e[tag=!laser,limit=1,sort=nearest,type=arrow,distance=..20]
execute as @s at @s run tag @e[tag=!laser,limit=1,sort=nearest,type=arrow,distance=..20] add laserlock
